...
Route::get('permission', [App\Http\Controllers\Controller::class, 'permission'])->name('permission');
Route::get('reporting', [App\Http\Controllers\Controller::class, 'reporting'])->name('reporting');
Route::get('financial', [App\Http\Controllers\Controller::class, 'financial'])->name('financial');
Route::get('services', [App\Http\Controllers\Controller::class, 'services'])->name('services');
Route::get('opportunities', [App\Http\Controllers\Controller::class, 'opportunities'])->name('opportunities');

Route::get('posts', [App\Http\Controllers\Controller::class, 'posts'])->name('posts');
Route::get('addpost', [App\Http\Controllers\Controller::class, 'addpost'])->name('addpost');

Route::get('chat', [App\Http\Controllers\Controller::class, 'chat'])->name('chat');
Route::get('GlanceDashboard', [App\Http\Controllers\Controller::class, 'GlanceDashboard'])->name('GlanceDashboard');
Route::get('mobileFriendly', [App\Http\Controllers\Controller::class, 'mobileFriendly'])->name('mobileFriendly');

Route::get('Users', [App\Http\Controllers\Controller::class, 'Users'])->name('Users');
Route::get('adduser', [App\Http\Controllers\Controller::class, 'adduser'])->name('adduser');

Route::get('EmailCompose', [App\Http\Controllers\Controller::class, 'EmailCompose'])->name('EmailCompose');
Route::get('EmailRead', [App\Http\Controllers\Controller::class, 'EmailRead'])->name('EmailRead');
Route::get('Emailinbox', [App\Http\Controllers\Controller::class, 'Emailinbox'])->name('Emailinbox');
