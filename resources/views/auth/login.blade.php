        ...
        <div class="row h-100" ">
            <div class="col-lg-6 col-12 " >
                <div id="auth-left">
                    ...
                    {{-- message --}}
                    {!! Toastr::message() !!}
                    <h1 class="auth-title my-0">@lang('site.Login')</h1>
                    ...
                    <div class="text-center mt-1 text-lg fs-4">
                        <p class="text-gray-600">Don't have an account? <a href="{{route('register')}}"
                                class="font-bold">@lang('site.Signup')</a>.</p>
                        <p><a class="font-bold" href="{{ route('forget-password') }}">@lang('site.Forgotpassword')</a>.</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-5 d-none d-lg-block" >
                <div id="auth-right"  >
                    <img  style="height: 100%" src="{{ URL::to('assets/images/login.JPG') }}" alt="">
                </div>
            </div>
        </div>
    </div>
