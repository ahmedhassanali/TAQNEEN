...
<div id="main"  >
    <div class="container-fluid"  style="postion: fixed; margin-right: 300px;">
        ...
        <div class="page-heading d-flex  justify-content-between align-items-center  ">
            <h3>@lang('site.ProfileStatistics')</h3>
        ...
        <div class="page-content">
            <section class="row">
                <div class="col-12 col-lg-9">
                            ...
                            <div class="card">
                                <div class="card-body px-3 py-4-5">
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <h6 class="text-muted font-semibold">@lang('site.ActivityLog')</h6>
                            ...
                            <div class="card">
                                <div class="card-body px-3 py-4-5">
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <h6 class="text-muted font-semibold">@lang('site.UserActivitylog')</h6>
                            ...
                            <div class="card">
                                <div class="card-body px-3 py-4-5">
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <h6 class="text-muted font-semibold">@lang('site.UserTotal')</h6>
                            ...
                            <div class="card">
                                <div class="card-body px-3 py-4-5">
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <h6 class="text-muted font-semibold">@lang('site.SavedRecord')</h6>
                    ...
                    <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <h5 class="mb-0 ms-3">السعودية</h5>
                                            </div>
                                        </div>
                                        <div class="col-6">
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <h5 class="mb-0 ms-3">الامارات</h5>
                                            </div>
                                        </div>
                                        <div class="col-6">
                        ...
                        <div class="col-12 col-xl-8">
                            <div class="card">
                                <div class="card-header">
                                    <h4>@lang('site.LatestComments')</h4>
                                </div>
                                <div class="card-body">
                                                ...
                                                <tr>
                                                    <td class="col-3">
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <p class="font-bold mx-3 mb-0">Mo Ahmed</p>
                                                        </div>
                                                    </td>
                                                    <td class="col-auto">
                                                        <p class=" mb-0">تهانينا على تخرجك!</p>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="col-3">
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <p class="font-bold mx-3 mb-0">Mo Hassan</p>
                                                        </div>
                                                    </td>
                                                    <td class="col-auto">
                                                        <p class=" mb-0">نجاح باهر تصميم مدهش! يمكنك جعل آخر
                                                            البرنامج التعليمي لهذا التصميم؟
                                                            </p>
                                                    </td>
                                                </tr>
                                            </tbody>
                ...
                <div class="col-12 col-lg-3">
                            ...
                            <div class="modal-dialog modal-dialog-scrollable" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="myModalLabel1">@lang('site.UserProfile')</h5>
                                    ...
                                    <div class="modal-body">
                                        <div class="form-body">
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <label>@lang('site.MobileNumber')</label>
                                                </div>
                                                <div class="col-md-8">
                                                    <div class="form-group has-icon-left">
                                                        <div class="position-relative">
                                                ...
                                                <div class="col-md-4">
                                                    <label>@lang('site.RoleName')</label>
                                                </div>
                                                <div class="col-md-8">
                                                    <div class="form-group has-icon-left">
                                                        <div class="position-relative">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h4>@lang('site.RecentMessages')</h4>
                        </div>
                        <div class="card-content pb-4">
                            <div class="recent-message d-flex px-4 py-3">
                                ...
                                <div class="name mx-4">
                                    <h5 class="mb-1">Ahmed said</h5>
                                    <h6 class="text-muted mb-0">@Ahsaid</h6>
                                </div>
                            </div>
                            <div class="recent-message d-flex px-4 py-3">
                                <div class="avatar avatar-lg">
                                ...
                                <div class="name mx-4">
                                    <h5 class="mb-1">Mohamed Said</h5>
                                    <h6 class="text-muted mb-0">@MSaid</h6>
                                </div>
                            </div>
                            <div class="recent-message d-flex px-4 py-3">
                                <div class="avatar avatar-lg">
                                ...
                                <div class="name mx-4">
                                    <h5 class="mb-1">Ali Ahmed</h5>
                                    <h6 class="text-muted mb-0">@AAhmed</h6>
                                </div>
                            </div>
                            <div class="px-4">
                                <button class='btn btn-block btn-xl btn-light-primary font-bold mt-3'
                                >@lang('site.StartConversation')</button>
                            </div>
                        </div>
                    </div>
                    <div class="card">
                        <div class="card-header">
                            <h4>@lang('site.VisitorsProfile')</h4>
                        </div>
                        <div class="card-body">
